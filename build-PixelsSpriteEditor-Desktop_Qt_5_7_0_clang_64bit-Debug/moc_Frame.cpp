...
#include "../PixelsSpriteEditor/Frame.h"
...
QT_MOC_LITERAL(3, 15, 6) // "Frame*"

    },
    "Frame\0clicked\0\0Frame*"
};
...
void Frame::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->clicked((*reinterpret_cast< Frame*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Frame::*_t)(Frame * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Frame::clicked)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Frame::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_Frame.data,
