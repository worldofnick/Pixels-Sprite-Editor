...
#include "../PixelsSpriteEditor/PopupWindow.h"
...
QT_MOC_LITERAL(1, 12, 8), // "rejected"
QT_MOC_LITERAL(2, 21, 0) // ""

    },
    "PopupWindow\0rejected\0"
};
...
void PopupWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (PopupWindow::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PopupWindow::rejected)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject PopupWindow::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_PopupWindow.data,
      qt_meta_data_PopupWindow,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
